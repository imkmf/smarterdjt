...
const Intro = ({ nextQuestion }) => (
  <article class="ph3 ph5-ns pb2 pt4">
    ...
    <p class="f5 f4-m f3-l lh-copy measure mt0">
      On Tuesday, October 10, 2017, Donald Trump <a class="dim" href="http://www.cnn.com/2017/10/10/politics/donald-trump-forbes-interview-rex-tillerson/index.html">challenged</a> Secretary of State Rex Tillerson to an IQ test. Donald Trump is confident that he will win. Can you beat Donald Trump in an IQ test? <span className="white">of course</span>
    </p>
    ...
    <p>
      <Button text="Take the 20 question test" action={nextQuestion} />
    </p>
